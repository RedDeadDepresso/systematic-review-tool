...
import CommentForm from '@/components/review-full-text-screening/comment-form';
import ContextMenu, {
  type ContextMenuProps,
} from '@/components/review-full-text-screening/context-menu';
import ExpandableTip from '@/components/review-full-text-screening/expandable.tip';
import HighlightContainer from '@/components/review-full-text-screening/highlight-container';
import HighLightSidebar from '@/components/review-full-text-screening/highlight-sidebar';
import { Header } from '@/components/review-full-text-screening/header';
import { FloatingActions } from '@/components/review-full-text-screening/floating-actions';
import {
  type GhostHighlight,
  LeftPanel,
  PdfHighlighter,
