...
<Image src="/screenshots/data-extraction/data-extraction.png" alt="Data Extraction table showing included references as rows, extraction questions as columns, and the Add Question popover open on the right" />
...
<Image src="/screenshots/data-extraction/pdf-viewer-form.png" alt="PDF viewer open in coding mode alongside the Data Extraction form sidebar showing questions and answer fields" />
