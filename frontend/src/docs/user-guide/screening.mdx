...
<Image src="/screenshots/screening/screening.png" alt="Screening page showing the reference list on the left, the detail panel in the centre, and the filter sidebar on the right" />
