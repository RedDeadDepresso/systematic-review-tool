...
<Image src="/screenshots/coding/coding.png" alt="Coding and Theming page showing three Kanban-style columns: Codes, Sub Themes, and Main Themes, with the Export dropdown open" />
...
<Image src="/screenshots/data-extraction/pdf-viewer-form.png" alt="PDF viewer in coding mode with a highlight annotation popover open and the coding sidebar listing existing codes and sub themes" />
