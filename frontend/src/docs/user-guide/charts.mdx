...
<Image src="/screenshots/charts/bar-chart.png" alt="Extraction Charts page showing the Frequency Bar Chart for a single-select extraction question" />
...
<Image src="/screenshots/charts/scatter-plot.png" alt="Scatter / Bubble Plot comparing two numeric extraction questions across references" />
...
<Image src="/screenshots/charts/evidence-gap-map.png" alt="Evidence Gap Map heatmap showing two categorical extraction questions on the row and column axes, with circle size indicating count" />
...
<Image src="/screenshots/charts/timeline.png" alt="Publication Timeline line chart showing the count of included references by publication year" />
