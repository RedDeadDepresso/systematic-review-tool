...
function ReviewPage() {
	...
	return (
		<AppLayout pageTitle={isLoading ? "..." : data.title} isAuthenticated={true}>
			<div className="space-y-6">
				{/* Review Info Section */}
				<Card className="p-6">
					<h2 className="mb-2 text-xl font-semibold text-foreground">Review Info</h2>
				...
				<Card className="p-6">
					<h2 className="mb-2 text-xl font-semibold text-foreground">Data Summary</h2>
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card className="p-6">
							<div className="space-y-4">
								...
								<p className="text-center text-4xl font-semibold text-foreground">7</p>
						...
						<Card className="p-6">
							<div className="space-y-4">
								...
								<p className="text-center text-4xl font-semibold text-foreground">0</p>
								<Button
							...
							<div className="space-y-4">
								...
								<div className="flex items-center justify-between">
									<div className="flex items-center gap-2">
										...
										<span className="text-sm text-muted-foreground">Not Duplicate</span>
									</div>
